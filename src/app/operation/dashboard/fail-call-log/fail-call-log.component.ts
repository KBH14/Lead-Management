...
@Component({
  selector: 'app-fail-call-log',
  templateUrl: './fail-call-log.component.html',
  styleUrls: ['./fail-call-log.component.css']
})
export class FailCallLogComponent implements OnInit {
